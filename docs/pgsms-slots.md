...
- [📂 Repositório GitHub](https://github.com/meuphilim/PGSMS-Slots)
...
![Screenshot do Projeto](../assets/images/PGSMS-Slots-screenshot.png)
![Diagrama de Arquitetura](../assets/images/PGSMS-Slots-architecture.png)
-->
